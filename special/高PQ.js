...
function action(mode,type,selection){
	...
	if(status == 0){
		var msg = "";
		msg += "                   #e#b高級考驗 - 森蘭丸#k\r\n\r\n";
		msg += icon1 + " #d本副本限定等級#k #r180等#k #d可進入\r\n";
		...
		if (cm.getParty() != null) {
            if (cm.getDisconnected("PQ3") != null) {
                cm.getDisconnected("PQ3").registerPlayer(cm.getPlayer());
                        ...
                        while (it.hasNext()) {
                            ...
                            if (ccPlayer == null || ccPlayer.getLevel() < 180 || ccPlayer.getPrizeLog(todayp + "航海") >= 3) {
                                next = false;
