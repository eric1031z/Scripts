...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		for(var a = 0 ; a < pack.length ; a++){
			msg += "#L" + a + "#"+icon3+"#b《 #k#r#e" + "龍魔" + " 龍任務!#n#k#b 》#k #d 查看任務通知#k\r\n";
		}
		cm.sendSimple(cm.getPlayer().getPrizeLog("龍魔任務") > 0 ? "您已完成#r" + "龍魔任" + " #k龍任務" : msg);
	}else if(status == 1){
		this. sel = selection;
		if(sel < 0){
			cm.dispose();
		...
		var checkitems = 1;
		var notice = "#b您欲完成#k #r" + "龍魔" + "任務 #b缺少以下材料 ：#k\r\n";
