    ...
    if (status == 0){
		...
		if(tier2 == 0){ 
			for(var o = 1 ; o < job[tier1].length ; o++){ 
			   msg += "#L" + job[tier1][o][0][0]  + "#" + icon3 + " #e#r" + MapleJob.getName(MapleJob.getById(job[tier1][o][0][0])) + "#k\r\n";
		    }
		}else if(tier3 == 0){
			for(var s = 0 ; s < job[tier1][tier2][1].length ; s++){ 
			   msg += "#L" + job[tier1][tier2][1][s]  + "#" + icon3 + " #e#r" + MapleJob.getName(MapleJob.getById(job[tier1][tier2][1][s])) + "#k\r\n";
		    }
			//msg += tier4;
		}else {
			msg += "#L" + job[tier1][tier2][tier3+1][tier4] + "#" + icon3 + " #e#r" + MapleJob.getName(MapleJob.getById(job[tier1][tier2][tier3+1][tier4])) + "#k\r\n";
			//msg += tier3;
		}
	    var add = "   " + cake + "" + cake + "" + cake + "" + cake + "" + cake + "" + cake + "" + cake + "" + cake + "" + cake + "" + cake + "" + cake + "" + cake + "" + cake + "" + cake+ "" + cake + "" + cake + "" + cake + "" + cake +  "  \r\n";
		cm.sendSimple("                    " + icon5 + " #d【轉職中心】#k\r\n\r\n" + add + "          " + icon1 + " #b重砲職業請在轉職前將技能點使用完#k\r\n#L9999##e" + icon3 + " #b我要滿技!#k\r\n" + msg); 
		}
		//cm.sendSimple(tier4);
	}else if(status == 1){
		var sel = selection
