var eventmapid = 271010100;
var returnmap = 980010000;
var monster = Array(8800100, 9400300, 8840000, 0, 2);
...
function setup(partyid) {
    ...
    map.toggleDrops();
    map.spawnNpc(9340003, new java.awt.Point(-289,-116));
...
function monsterSpawn(eim) { // Custom function
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-582, 154));
}
...
function allMonstersDead(eim) {
    ...
    eim.broadcastPlayerMsg(5, "恭喜獲得 " + num + " Boss Points! 目前累計共 " + totalp + " Boss Points!");

    eim.saveBossQuest(num);

    if (mobnum < monster.length) {
        eim.broadcastPlayerMsg(5, "下一關即將開始！準備好了嗎？");
    } else {
        eim.saveBossQuest(15000);
        eim.saveNX(80);
        eim.broadcastPlayerMsg(5, "恭喜完成超高難度模式，額外獲得 15000 Boss Points。");
