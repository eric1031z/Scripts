...
function removeItem(id){
	var p = cm.getPlayer().getParty().getMembers().iterator();
	while(p.hasNext()){
		var player = cm.getPlayer().getClient().getChannelServer().getPlayerStorage().getCharacterById(p.next().getId());
		if(player != null){
			//var count = player.itemQuantity(id);
		    player.removeAll(id);
		}
