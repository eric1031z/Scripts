...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		cm.resetMap(272010200);
		//cm.getPlayer().getMap().spawnNpc(2144019,new java.awt.Point(805,8));
		...
		cm.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeFactory.getMonster(8860001),new java.awt.Point(141,71));
		//cm.removeNpc(272010200, 2144019);
		cm.dispose();
	}
}
