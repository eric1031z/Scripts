...
function action(mode, type, selection) {
    if (cm.getQuestStatus(21002) == 0) {
        ...
        if (status == 0) {
            ...
            switch (selection) {
                case 0:
                    cm.sendOk("聽說黑魔法師就在不遠處。因為成為黑魔法師部下的龍群阻擋，根本無法通過森林。所以我們才打造了逃生船。現在只能飛往維多利亞島逃難…");
                    break;
                case 1:
                    cm.sendOk("逃難準備幾乎都做好了。可以搭載的人全部坐上方舟了。現在只剩下幾個人搭乘後就可以出發前往維多利亞島。 神獸答應在逃生船飛行的期間阻擋空中的攻擊…沒有人留下來守護這裡…");
                    break;
                case 2:
