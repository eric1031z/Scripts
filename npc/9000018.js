...
var icon1 = "#fUI/UIWindow/Quest/icon0#";
var icon5 = "#fItem/Etc/0422/04220176/info/iconRaw#";
...
function action(mode, type, selection) {
	...
	if (mode != 1) {
		...
		if (status == 0) {
			...
			var selStr = "目前勝利 : " + cm.getPlayer().getTotalWins() + ", 目前失敗 : " + cm.getPlayer().getTotalLosses() + ", 當前勝利 : "  + "\r\n想要查看哪一隻神奇寶貝的素質呢?\r\n\r\n#b";
			...
			if (battlers[0] == null) {	
				cm.getPlayer().makeBattler(0, 1210102);
				cm.getPlayer().makeBattler(1, 1210100);
				cm.getPlayer().makeBattler(2, 210100);
				cm.sendOk("恭喜您已經獲得第一隻神奇寶貝，想要訓練您的神奇寶貝或是跟玩家挑戰可以到「網咖」");
				cm.dispose();
				return;
			}
			...
			sel = selection;
			var info = "#e#r" + battlers[selection].getName() + "#n#k#b (#o" + battlers[selection].getMonsterId() + "#)#k\r\n\r\n";
